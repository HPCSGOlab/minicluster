...
class common_config {
  ...
  package { ['git', 'build-essential', 'libopenmpi-dev', 'libgl1-mesa-dev', 'python3', 'python3-pip', 'python3-dev', 'libglew-dev', 'glew-utils', 'htop', 'libglfw3-dev', 'libxxf86vm-dev', 'libxi-dev', 'xorg-dev', 'libudev-dev', 'apt-utils', 'valgrind']:
    ensure => 'installed',
  }
